...
VL_INLINE_OPT void Vcore::_sequent__TOP__1(Vcore__Syms* __restrict vlSymsp) {
    ...
    if (vlTOPp->reset) {
        ...
        if (vlTOPp->core__DOT__bitty_core_inst__DOT__en_7) {
            vlTOPp->core__DOT__bitty_core_inst__DOT__reg7 
                = vlTOPp->core__DOT__last_alu_result;
        }
    }
    if (vlTOPp->reset) {
    ...
    if (vlTOPp->reset) {
        vlTOPp->core__DOT__ifu_inst__DOT__next_address = 0U;
    } else {
        if (vlTOPp->core__DOT__bitty_core_done) {
            vlTOPp->core__DOT__ifu_inst__DOT__next_address 
                                                                 ...
                                                                 ((2U 
                                                                  ...
                                                                  ((1U 
                                                                   ...
                                                                   ((IData)(vlTOPp->core__DOT__bitty_core_inst__DOT__to_ina) 
                                                                    ...
                                                                    : 
                                                                   ((IData)(vlTOPp->core__DOT__bitty_core_inst__DOT__to_ina) 
                                                                    + (IData)(vlTOPp->core__DOT__bitty_core_inst__DOT__mux_out)))))), (IData)(vlTOPp->core__DOT__last_alu_result));
}
...
VL_INLINE_OPT void Vcore::_sequent__TOP__6(Vcore__Syms* __restrict vlSymsp) {
    ...
    // Body
    if (vlTOPp->reset) {
        vlTOPp->core__DOT__last_alu_result = 1U;
    } else {
        if (vlTOPp->core__DOT__bitty_core_inst__DOT__en_c) {
            vlTOPp->core__DOT__last_alu_result = (0xffffU 
                                                  & ((4U 
                                                      & (IData)(vlTOPp->core__DOT__bitty_core_inst__DOT__sel_to_alu))
                                                      ? 
                                                     ((2U 
