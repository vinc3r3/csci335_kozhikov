...
VL_MODULE(Vifu) {
  public:
    ...
    VL_IN8(en_pc,0,0);
    VL_IN8(done,0,0);
    VL_IN16(last_alu,15,0);
    VL_OUT16(instruction,15,0);
    
    // LOCAL SIGNALS
    // Internals; generally not touched by application code
    SData/*11:0*/ ifu__DOT__current_address;
    SData/*11:0*/ ifu__DOT__next_address;
    SData/*15:0*/ ifu__DOT__Memory__DOT__my_memory[4096];
  ...
  public:
    ...
    static void _settle__TOP__4(Vifu__Syms* __restrict vlSymsp);
