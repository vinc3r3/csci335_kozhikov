...
VL_INLINE_OPT QData Vand_gate::_change_request_1(Vand_gate__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vand_gate::_change_request_1\n"); );
    Vand_gate* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // Change detection
