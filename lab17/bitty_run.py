...
MODULES = ['alu', 'mux', 'control_unit', 'register', 'ifu', 'bitty_core', 'core']
# MODULES.append("alu")

# Linux commands invoked within this script.
# Verilator command to generate C++ and Makefiles.
VERILATE_COMMAND = (
    "verilator --assert -I./rtl --Wall {0} --cc ./rtl/{1}.v --exe ./test/{1}/{1}_tb.cpp "
    "./emulator/BittyEmulator.cpp ./bitty_dpi.cpp")
